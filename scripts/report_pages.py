...
.report-hero .report-subtitle {
    font-size: 1.15rem;
    color: var(--abm-text-secondary, #94a3b8);
    margin-bottom: 0;
}
.report-content {
    max-width: 800px;
...
.report-stat-card {
    background: var(--abm-bg-surface);
    border: 1px solid var(--abm-border, rgba(255,255,255,0.1));
    border-radius: 12px;
    padding: 1.25rem;
    text-align: center;
}
...
.report-gate {
    background: var(--abm-bg-surface);
    border: 2px solid var(--abm-accent);
    border-radius: 16px;
    padding: 2.5rem 2rem;
    text-align: center;
    margin: 2.5rem 0;
...
.report-gate-form input[type="email"] {
    ...
    font-size: 1rem;
    background: var(--abm-bg-surface);
    color: var(--abm-text-primary, #f1f5f9);
}
...
.report-gate-form button:hover {
    background: var(--abm-accent-hover);
}
.report-download-btn {
    display: none;
